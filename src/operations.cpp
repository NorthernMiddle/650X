...
int tankDrive_f(){
 ...
 while(true){
  ...
  // STRAF motor commmands
  if(Controller1.ButtonR1.pressing()){
    STRAFmotor.spin(forward, 100, velocityUnits::pct);
    }
  else if(Controller1.ButtonR2.pressing()){
    STRAFmotor.spin(reverse, 100, velocityUnits::pct);
    }
  else{
    STRAFmotor.stop(brake);
  }
...
int trayLift_f(){
  ...
  if((( manual_mode == true ) && (( Controller1.ButtonX.pressing()) == true )))
  manual_mode = true;
  while(( manual_mode == true ) && (( Controller1.ButtonX.pressing() == true))){
    trayLiftSpinUp();}
  ...
  if(( manual_mode == true ) && ((Controller1.ButtonB.pressing()) == true ))
    manual_mode = true;
    while(( manual_mode == true ) && ( Controller1.ButtonB.pressing() == true ) && 
