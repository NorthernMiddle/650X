...
int tankDrive_f(){
  ...
  while(true){
    ...
    l_joyStickValue = Controller1.Axis3.position();   // left-joystick tank drive control
    r_joyStickValue = Controller1.Axis2.position();   // right-joystick tank drive control
